$(document).ready(function(){
    ...
    //         add_polyline(insert_element, startparam, endparam, divide, knot,
    //             'stroke:rgb(255,255,255);stroke-width:8;fill:none;stroke-linecap:butt;', close);
    //     }
    // };
    ...
    //     BackDrawKnot: function(insert_element, startparam, endparam, divide, knot, close) {
    //         add_polyline(insert_element, startparam, endparam, divide, knot,
    //             'stroke:rgb(255,255,255);stroke-width:12;fill:none;stroke-linecap:butt;', close);
    //     }
    // };
    ...
    //             Drawer: draw2,
    //             Divide: 10,
    //             Points: [ [-25,-100], [25,-100], [25,-75], [25,-50], [25,-25], [50,-25], [75,-25], [100,-25], [100,25], [75,25], [50,25], [25,25], [25,50], [25,75], [25,100], [-25,100], [-25,75], [-25,50], [-25,25], [-50,25], [-75,25], [-100,25], [-100,-25], [-75,-25], [-50,-25], [-25,-25], [-25,-50], [-25,-75] ],
    //         },
    //         {
    //             Drawer: draw3,
    //             Divide: 10,
    ...
    // var spline = MakeNonUniformBSplineCombined([
    //     { pnt: [-50, 50], par: 1 },
    //     { pnt: [50, 50], par: 1 },
    //     { pnt: [50, -50], par: 1 },
    //     { pnt: [-50, -50], par: 1 },
    ...
    add_polyline($(".test-line"), spline.StartParam, spline.EndParam, 10, spline,
        'stroke:rgb(255,0,255);stroke-width:2;fill:none;stroke-linecap:butt;', true, 0);
});
